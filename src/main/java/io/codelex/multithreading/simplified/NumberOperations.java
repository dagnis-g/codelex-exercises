...
public class NumberOperations {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        Runnable sumOfList = () -> {
            System.out.println(numberList.stream().mapToInt(i -> i).sum());
        };
        Runnable averageOfList = () -> {
            System.out.println(numberList.stream().mapToInt(Integer::intValue).summaryStatistics().getAverage());
        };
        ...
        executor.execute(sumOfList);
        executor.execute(averageOfList);
